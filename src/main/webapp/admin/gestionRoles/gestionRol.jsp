...
<s:form action="busquedaRol" namespace="/" method="post">
	<table>
		<tr>		
	    	<td colspan="8" bgcolor="" class="celda_gris2">B&uacute;squeda de Roles:</td>
	  		<td>&nbsp;</td>
	  	</tr>
		<tr>
		...
		<tr>
			<td colspan="6" bgcolor="#DBE2EA" class="texto1">
				<br/>
				<input name="submit" type="image" src="<s:url value='/WEB-INF/images/buscar.gif'/>" width="93" height="32" border="0"/>
				<s:url action="altaRol.action" var="altaRol">
					<s:param name="idRol" value="0"/>
				</s:url>
				<a href="<s:property value='altaRol'/>">
					<img alt="alta" src="<s:url value='/WEB-INF/image/altaRol.gif'/>" width="93" height="32" border="0" longdesc="Crear nuevo Rol"/>
				</a>
			</td>
			<td>&nbsp;</td>
		</tr>
...
<s:if test="!empty roles">
	<table width="95%" border="0" cellspacing="0" cellpadding="0" class="tabla">
		<tr>
			<td class="titListado">Se encontraron estos roles correspondientes al criterio de b&uacute;squeda : </td>
	  	</tr>
	</table>
	...
	<div id="one">
		...
		<sjg:grid gridModel="roles" id="idLista" caption="roles alamcenados" dataType="html" pager="true" rowList="3,5,8" rowNum="5" rownumbers="true">
			<sjg:gridColumn name="nombre" index="nombre" title="Nombre" formatter="string" sortable="true"></sjg:gridColumn>
			<sjg:gridColumn name="descripcion" index="descripcion" title="Descripcion"></sjg:gridColumn>
			<sjg:gridColumn name="editar"></sjg:gridColumn>
		</sjg:grid>
	</div>
	</sj:tabbedpanel>
</s:if>
