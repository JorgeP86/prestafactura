...
public class AltaDatosPropiosFormAction extends ActionSupport{


	private static final long serialVersionUID = 1L;
	
	private static final Logger logger = Logger.getLogger(AltaDatosPropiosFormAction.class);
	...
	public String execute() {
		try{
			...
			logger.info("Obtenido los datos para cargar el formulario_AltaDatosPropios");
		}catch(Exception e){
